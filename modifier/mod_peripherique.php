...
{
	$eid=$_REQUEST["eid"];
	$req=mysql_query("select * from peripheriques where id='$eid'");
...
if(isset($_REQUEST["enregistrer"]))
{
  ...
  mysql_query("update peripheriques set nom='$nom',type='$type',fabriquant='$fabriquant',modele='$modele',lieu='$lieu',affectation='$affectation',num_serie='$num_serie',code_inv='$code_inv',date_achat='$date_achat',commentaires='$commentaires' where id='$eid' ");
...
<tr>
									 ...
									 <td><select name="type">
										 ...
										 <?php
										 $re ="select type from type_peripheriques";
...
<tr>
                    ...
                    <td><select name="fabriquant">
                      ...
                      <?php
                      $re ="select fabriquant from fabriquant_peripheriques";
											$rq = mysql_query($re) or die(mysql_error());
							  			 while($ET=mysql_fetch_assoc($rq))
                      {
...
<tr>
                    ...
                    <td><select name="modele">
                      ...
                      <?php
                      $re ="select modele from modele_peripheriques";
											$rq = mysql_query($re) or die(mysql_error());
							  			 while($ET=mysql_fetch_assoc($rq))
                      {
