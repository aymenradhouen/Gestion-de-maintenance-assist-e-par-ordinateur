...
if(isset($_REQUEST["supprimer"]))
{
  ...
  $a=implode(",",$delid);
  mysql_query("delete from consommables where id in ($a)");
...
$req="select * from consommables order by id";
...
<h1 align="">Consommables :</h1>
<?php if($_SESSION['type'] == "Administrateur du parc" || $_SESSION['type'] == "Administrateur"){ ?>
<form method="post" action="ajouter/ajouter_consommable.php">
...
<a class="link" id="id4" onclick="hide4()" href="#" style="display:none">supprimer</a><input type="text" id="myInput3" onkeyup="myFunction3()" placeholder="Chercher un lieu ..." title="Ecrire un lieu" style='display:none'>
<a class="link" id="id5" onclick="hide5()" href="#" style="display:none">supprimer</a><input type="text" id="myInput4" onkeyup="myFunction4()" placeholder="Chercher une affectation ..." title="Ecrire une affectation" style='display:none'>
<a class="link" id="id6" onclick="hide6()" href="#" style="display:none">supprimer</a><input type="text" id="myInput5" onkeyup="myFunction5()" placeholder="Chercher une date ..." title="Ecrire une date" style='display:none'>
