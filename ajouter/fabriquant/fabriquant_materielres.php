  ...
  if(!empty($_POST['fabriquant']))
   {
     ...
     $req ="insert into fabriquant_materielres VALUES ('$id','$fabriquant')";
     mysql_query($req);
     header('Location: ../ajouter_materielres.php');
   }
   else echo "<p class='faux'>Champs requis ne sont pas remplis</p>";
}
$req = "select * from fabriquant_materielres order by id";
$rs=mysql_query($req);

if(isset($_REQUEST["delid"]))
{
  $delid=$_REQUEST["delid"];
  mysql_query("delete from fabriquant_materielres where id='$delid'");
  header('Location: fabriquant_materielres.php');
}
...
<h1 align="">Ajouter un fabriquant de materiel reseau :</h1><br />
<form method="post" action="">
                     ...
                     <a href="../ajouter_materielres.php">
      ...
      <table class="tab" border="1" width="40%" align="center">
         ...
         <tr>
           <td><?php echo($ET['fabriquant'])?></td>
             <td><a href="fabriquant_materielres.php?delid=<?php echo($ET['id'])?>">Supprimer</a></td>
         </tr>
         <?php } ?>
