  ...
  if(!empty($_POST['fabriquant']))
   {
     ...
     $req ="insert into fabriquant_consommables VALUES ('$id','$fabriquant')";
     mysql_query($req);
     header('Location: ../ajouter_consommable.php');
   }
   else echo "<p class='faux'>Champs requis ne sont pas remplis</p>";
}
$req = "select * from fabriquant_consommables order by id";
$rs=mysql_query($req);

if(isset($_REQUEST["delid"]))
{
  $delid=$_REQUEST["delid"];
  mysql_query("delete from fabriquant_consommables where id='$delid'");
  header('Location: fabriquant_consommable.php');
}
...
<h1 align="">Ajouter un fabriquant de consommable :</h1><br />
<form method="post" action="">
                     ...
                     <input name="enregistrer" type="submit" value="Ajouter">
                     <a href="../ajouter_consommable.php">
        ...
        <table class="tab" border="1" width="40%" align="center">
           ...
           <tr>
             <td><?php echo($ET['fabriquant'])?></td>
               <td><a href="fabriquant_consommable.php?delid=<?php echo($ET['id'])?>">Supprimer</a></td>
           </tr>
           <?php } ?>
