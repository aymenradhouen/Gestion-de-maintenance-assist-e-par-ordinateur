  ...
  if(!empty($_POST['nom'])&&!empty($_POST['type'])&&!empty($_POST['fabriquant'])&&!empty($_POST['modele'])&&!empty($_POST['num_serie'])&&!empty($_POST['code_inv'])&&!empty($_POST['lieu'])&&!empty($_POST['affectation']))
   {
     ...
     $req ="insert into peripheriques VALUES ('$id','$nom','$type','$fabriquant','$modele','$lieu','$affectation','$num_serie','$code_inv','$date_achat','$commentaires')";
     mysql_query($req);
...
<h1 align="">Ajouter un peripherique :</h1><br />
...
<tr>
                   ...
                   <td><select name="type">
                     <?php
                     $req ="select type from type_peripheriques";
                   ...
                   <a href="type/type_peripherique.php"><img class="img" src="add.jpg"></a></td>
</tr>
<tr>
                   <td>Fabriquant :</td>
                   <td><select name="fabriquant">
                     <?php
                     $req ="select fabriquant from fabriquant_peripheriques";
                     $rs = mysql_query($req) or die(mysql_error());
                     while($ET=mysql_fetch_assoc($rs))
                     {
                   ...
                   <a href="fabriquant/fabriquant_peripherique.php"><img class="img" src="add.jpg"></a></td>
</tr>
<tr>
                   <td>Modele :</td>
                   <td><select name="modele">
                     <?php
                     $req ="select modele from modele_peripheriques";
                     $rs = mysql_query($req) or die(mysql_error());
                     while($ET=mysql_fetch_assoc($rs))
                     {
                   ...
                   <a href="modele/modele_peripherique.php"><img class="img" src="add.jpg"></a></td>
</tr>
<tr>
                   <td>Lieu :</td>
                   <td><select name="lieu">
