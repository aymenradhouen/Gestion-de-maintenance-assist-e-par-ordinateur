...
{
  if(!empty($_POST['nom'])&&!empty($_POST['type'])&&!empty($_POST['fabriquant'])&&!empty($_POST['modele'])&&!empty($_POST['num_serie'])&&!empty($_POST['code_inv'])&&!empty($_POST['carac'])&&!empty($_POST['taille'])&&!empty($_POST['lieu'])&&!empty($_POST['affectation']))
   {
     ...
     $req ="insert into moniteurs VALUES ('$id','$nom','$type','$fabriquant','$modele','$lieu','$affectation','$num_serie','$code_inv','$d','$taille','$date_achat','$commentaires')";
...
<h1 align="">Ajouter un moniteur :</h1><br />
...
<tr>
                     ...
                     <td><select name="type">
                       <?php
                       $req ="select type from type_moniteurs";
                     ...
                     <a href="type/type_moniteur.php"><img class="img" src="add.jpg"></a></td>
</tr>
<tr>
                     <td>Fabriquant :</td>
                     <td><select name="fabriquant">
                       <?php
                       $req ="select fabriquant from fabriquant_moniteurs";
                       $rs = mysql_query($req) or die(mysql_error());
                       while($ET=mysql_fetch_assoc($rs))
                       {
                     ...
                     <a href="fabriquant/fabriquant_moniteur.php"><img class="img" src="add.jpg"></a></td>
</tr>
<tr>
                     <td>Modele :</td>
                     <td><select name="modele">
                       <?php
                       $req ="select modele from modele_moniteurs";
                       $rs = mysql_query($req) or die(mysql_error());
                       while($ET=mysql_fetch_assoc($rs))
                       {
                     ...
                     <a href="modele/modele_moniteur.php"><img class="img" src="add.jpg"></a></td>
</tr>
<tr>
                     <td>Lieu :</td>
                     <td><select name="lieu">
...
<tr>
										 ...
										 <td><input type="checkbox" name="carac[]" value="microphone">Microphone
										 <input type="checkbox" name="carac[]" value="subd">SubD
										 <input type="checkbox" name="carac[]" value="dvi">Dvi
										 <input type="checkbox" name="carac[]" value="hdmi">HDMI
                     <input type="checkbox" name="carac[]" value="enceinte">Enceinte
                     <input type="checkbox" name="carac[]" value="bnc">Bnc
										 <input type="checkbox" name="carac[]" value="pivot">Pivot</td>
</tr>
<tr>
                     <td>Taille :</td>
