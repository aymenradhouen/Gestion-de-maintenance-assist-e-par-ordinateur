...
{
  if(!empty($_POST['nom'])&&!empty($_POST['type'])&&!empty($_POST['fabriquant'])&&!empty($_POST['lieu'])&&!empty($_POST['affectation']))
   {
     ...
     $req ="insert into consommables VALUES ('$id','$nom','$type','$fabriquant','$lieu','$affectation','$date_achat','$commentaires')";
     mysql_query($req);
...
<h1 align="">Ajouter un consommable :</h1><br />
<form method="post" action="">
                    ...
                    <tr>
                     ...
                     <td><select name="type">
                       <?php
                       $req ="select type from type_consommables";
                      ...
                      <a href="type/type_consommable.php"><img class="img" src="add.jpg"></a></td>
                    </tr>
                    ...
                    <td>Fabriquant :</td>
                     <td><select name="fabriquant">
                       <?php
                       $req ="select fabriquant from fabriquant_consommables";
                       $rs = mysql_query($req) or die(mysql_error());
                       while($ET=mysql_fetch_assoc($rs))
                       {
                      ...
                      <a href="fabriquant/fabriquant_consommable.php"><img class="img" src="add.jpg"></a></td>
                    </tr>
