...
if(isset($_REQUEST["supprimer"]))
{
  ...
  $a=implode(",",$delid);
  mysql_query("delete from materiel_reseaux where id in ($a)");
  } else echo "<div class='alert'>
 <span class='closebtn' onclick='this.parentElement.style.display='none';'>&times;</span>
 Veuillez selectioner quelque chose a supprimer.
</div>";
}
$req="select * from materiel_reseaux order by id";
...
<body>
  ...
  ?>
  <a class="link" href="./ajouter/ajouter_demande.php?mid=<?php echo($did)?>">Ajouter une demande pour cet equipement</a>
  <?php
...
<h1 align="">Matériels reseaux :</h1>
<?php if($_SESSION['type'] == "Administrateur du parc" || $_SESSION['type'] == "Administrateur"){ ?>
<form method="post" action="ajouter/ajouter_materielres.php">
...
<select id="myselect" onclick="message()">
  <optgroup label="Caractéristiques">
    ...
    <option value="adresse_mac">Adresse MAC</option>
...
<a class="link" id="id9" onclick="hide9()" href="#" style="display:none">supprimer</a><input type="text" id="myInput8" onkeyup="myFunction8()" placeholder="Chercher une adresse MAC ..." title="Ecrire une adresse MAC" style='display:none'>
