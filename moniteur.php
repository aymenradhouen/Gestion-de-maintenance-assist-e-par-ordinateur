...
if(isset($_REQUEST["supprimer"]))
{
  ...
  $a=implode(",",$delid);
  mysql_query("delete from moniteurs where id in ($a)");
  }else echo "<div class='alert'>
 <span class='closebtn' onclick='this.parentElement.style.display='none';'>&times;</span>
 Veuillez selectioner quelque chose a supprimer.
</div>";
}
$req="select * from moniteurs order by id";
...
?>
<a class="link" href="./ajouter/ajouter_demande.php?moid=<?php echo($did)?>">Ajouter une demande pour cet equipement</a>
<?php
...
<h1 align="">Moniteurs :</h1>
<?php if($_SESSION['type'] == "Administrateur du parc" || $_SESSION['type'] == "Administrateur"){ ?>
<form method="post" action="ajouter/ajouter_moniteur.php">
...
<a class="link" id="id10" onclick="hide10()" href="#" style="display:none">supprimer</a><input type="text" id="myInput9" onkeyup="myFunction9()" placeholder="Chercher une taille ..." title="Ecrire une taille" style='display:none'>
<a class="link" id="id11" onclick="hide11()" href="#" style="display:none">supprimer</a><input type="text" id="myInput10" onkeyup="myFunction10()" placeholder="Chercher une date ..." title="Ecrire une date" style='display:none'>
